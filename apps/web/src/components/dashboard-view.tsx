  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold mb-1">Welcome to cd judge! 👋</h2>
          <p className="text-muted-foreground">
            You're running on the{' '}
            <span className="text-foreground font-medium">Free Tier</span>. Everything looks
            healthy.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <select className="bg-muted border border-border text-foreground text-sm rounded-lg p-2 focus:ring-1 focus:ring-ring outline-none">
          ...
          <div className="space-y-4 flex-1">
            {[
              ...
              <div key={idx} className="flex items-start gap-3">
                <div
                  className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center text-xs flex-shrink-0 ${step.done
